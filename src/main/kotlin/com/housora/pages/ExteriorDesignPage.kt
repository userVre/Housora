...
fun HTML.exteriorDesignPage() {
    toolPage(ToolPageConfig(
        ...
        heroAction = "Redesign",
        heroElement = "House",
        heroWords = listOf("House", "Apartment", "Office", "Residential", "Retail", "Villa"),
        heroSlides = listOf("/static/images/tools/exterior-design-hero.jpg", "/static/images/exterior-after.jpg", "/static/images/gallery-colonial.jpg", "/static/images/gallery-barn.jpg"),
