...
const inputTrailingButtonStyles = (theme) => ({
		...
		button: {
			"&[data-variant=\"solid\"]": {
				...
				"&[data-color=\"primary\"]": {
					...
					"&:focus:not(:focus-visible)": { boxShadow: BUTTON_SOLID_SHADOW(theme.colors.$primary500) },
					"&:focus-visible": { boxShadow: [BUTTON_SOLID_SHADOW(theme.colors.$primary500), theme.shadows.$focusRing.replace("{{color}}", theme.colors.$colorRing)].toString() }
				},
				"&[data-color=\"danger\"]": {
					...
					"&:focus:not(:focus-visible)": { boxShadow: BUTTON_SOLID_SHADOW(theme.colors.$danger500) },
					"&:focus-visible": { boxShadow: [BUTTON_SOLID_SHADOW(theme.colors.$danger500), theme.shadows.$focusRing.replace("{{color}}", theme.colors.$dangerAlpha200)].toString() }
				}
			},
			"&[data-variant=\"outline\"]": {
				...
				"&:focus:not(:focus-visible)": { boxShadow: BUTTON_OUTLINE_SHADOW(theme.colors.$borderAlpha100) },
				"&:focus-visible": { boxShadow: [BUTTON_OUTLINE_SHADOW(theme.colors.$borderAlpha100), theme.shadows.$focusRing.replace("{{color}}", theme.colors.$colorRing)].toString() }
			},
