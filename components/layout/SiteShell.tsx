...
function Footer() {
  ...
  return <footer className="site-footer"><div className="footer-main"><div className="footer-brand"><span className="footer-brand-name">HOUSORA</span><p>Ideas for real homes, shaped around your space.</p></div><div className="footer-columns"><div><strong>AI Tools</strong><Link href="/interior-design">Interior design</Link><Link href="/exterior-design">Exterior design</Link><Link href="/garden-design">Garden design</Link></div><div><strong>Information</strong><Link href="/examples">Examples</Link><Link href="/faq">FAQ</Link><Link href="/blog">Blog</Link></div><div><strong>Support</strong><Link href="/contact">Contact</Link><Link href="/pricing">Pricing</Link><Link href="/enterprise">Enterprise</Link></div></div></div><div className="footer-bottom-bar"><span className="footer-logo-bottom">HOUSORA</span><div className="footer-bottom-links"><Link href="/privacy">Privacy Policy</Link><Link href="/terms">Terms &amp; Conditions</Link><Link href="/cookies">Cookie Policy</Link><Link href="/refund-policy">Refund Policy</Link><button type="button" className="footer-cookie-settings" onClick={openCookies}>Cookie settings</button></div><span className="footer-copy">© 2026 Housora</span></div></footer>;
}
